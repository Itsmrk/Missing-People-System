    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <h1 class="text-primary pt-4 h1-s">
                <i class="fas fa-file-alt"></i> Approved Posts: <small class="text-dark"> View All Posts</small>
            </h1>
            <hr>
            <ol class="breadcrumb bc-s">
                <li><a href="approved_posts.php" class="pr-1"><i class="fa fa-tachometer"></i> Dashboard / </a></li>
              <li class="active pl-1"><i class="fas fa-file-alt"></i> View All Approved Posts </li>
            </ol>
            
            
               <?php
                    if($_SESSION['role'] == 'admin'){
                        $query = "SELECT * FROM posts WHERE status = 'publish' ORDER BY post_id DESC";
                        $run = mysqli_query($con, $query);
                    }
                    else if($_SESSION['role'] == 'user'){
                        $query = "SELECT * FROM posts WHERE status = 'publish' and user = '$session_email' ORDER BY post_id DESC";
                        $run = mysqli_query($con, $query);
                    }
