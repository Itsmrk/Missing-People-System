                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4 mt-3">Enter your New And Confirm Password then we will Change your password.</p>
                                </div>
                                 <?php if (isset($msg)) { echo $msg; } ?>
                            <?php if (isset($errMsg)) { echo $errMsg; } ?>

                                <form action="new_password.php" method="POST" enctype="multipart/form-data" autocomplete="off">
